...
public class PortfolioController {
	...
	public PortfolioPositionsDto portfolioPositions(Principal principal) {
	...
	public void deleteTransactionFromPortfolio(@RequestBody DeleteTransactionsDto request, Principal principal) {
		String username = principal.getName();
	...
	public void createPortfolio(Principal principal) {
		String username = principal.getName();
